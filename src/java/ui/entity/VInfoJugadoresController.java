...
public class VInfoJugadoresController implements Serializable {
    ...
    public VInfoJugadoresController() {
    }

    public VInfoJugadores getSelected() {
        return selected;
    }

    public void setSelected(VInfoJugadores selected) {
    ...
    private VInfoJugadoresFacade getFacade() {
        return ejbFacade;
    }

    public VInfoJugadores prepareCreate() {
        selected = new VInfoJugadores();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("VInfoJugadoresCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("VInfoJugadoresUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("VInfoJugadoresDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<VInfoJugadores> getItems() {
        if (items == null) {
    ...
    public List<VInfoJugadores> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<VInfoJugadores> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
